        ...
        <ul class="nav">
          <li class="nav-item nav-profile">
            <div class="nav-link">
              ...
              <button class="btn btn-success btn-block" data-toggle="modal" data-target="#uploadModal">Agregar Mesa</button>
            </div>
          </li>
          <li class="nav-item">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" method='post' action='' enctype="multipart/form-data">
                ...
                <br>
                <button id="addTableButton" name="addTableButton" type="button" onclick="addTable()" class="btn btn-success btn-fw">Agregar</button>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" method='post' action='' enctype="multipart/form-data">
                ...
                Mesero
                <select name="empleadosSelect" id='empleadosSelect'>
                  <?php
                  $db = new DbOperations();
                  $db->getEmployeesForBill();
                   ?>
                </select>
                <br>
              </form>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-danger btn-fw" data-dismiss="modal"> Cancelar</button>
              <button type="button" class="btn btn-success btn-fw" onclick='assignTableToBill()'>Asignar</button>
            </div>
          </div>
        </div>
      </div>
